...
<div class="sidebar-heading">
  Sample Header or Grup Menu
</div>
{{-- nav item singgle menu without collapse --}}
<li class="nav-item">
  <a class="nav-link" href="#">
    <i class="fas fa-fw fa-list"></i>
    <span>Sample Menu 1</span></a>
</li>
<!-- Nav Item - Pages Collapse Menu -->
<li class="nav-item">
  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#sampleMenu" aria-expanded="true"
    aria-controls="sampleMenu">
    <i class="fas fa-fw fa-cog"></i>
    <span>Sample Menu 2</span>
  </a>
  <div id="sampleMenu" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <h6 class="collapse-header">Sample Header :</h6>
      <a class="collapse-item" href="#">Menu 2.1</a>
      <a class="collapse-item" href="#">Menu 2.2</a>
      <a class="collapse-item" href="#">Menu 2.2</a>
    </div>
  </div>
</li>
...
<li class="nav-item">
  ...
  <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="/template/form">Form Sample</a>
      <div class="collapse-divider"></div>
